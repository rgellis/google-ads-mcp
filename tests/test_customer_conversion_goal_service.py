...
class TestCustomerConversionGoalService:
    ...
    async def test_mutate_customer_conversion_goals_update(
        ...
        operations = [
            {
                "update": {
                    "resource_name": "customers/1234567890/customerConversionGoals/PURCHASE~WEBSITE",
                    "biddable": True,
                }
            }
        ]
    ...
    async def test_mutate_customer_conversion_goals_disable_biddable(
        ...
        operations = [
            {
                "update": {
                    "resource_name": "customers/1234567890/customerConversionGoals/LEAD~WEBSITE",
                    "biddable": False,
                }
            }
        ]
    ...
    async def test_mutate_customer_conversion_goals_rejects_category_and_origin(
        ...
        operations = [
            {
                "update": {
                    "resource_name": "customers/1234567890/customerConversionGoals/SIGNUP~WEBSITE",
                    "category": "SIGNUP",
                    "origin": "WEBSITE",
                    "biddable": True,
                }
