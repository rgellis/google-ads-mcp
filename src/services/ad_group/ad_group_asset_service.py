...
def _asset_field_type_segment(field_type: Any) -> str:
    """Return the AssetFieldType enum NAME for the third segment of an
    AdGroupAsset compound resource name.

    Google Ads' compound resource_name format for AdGroupAsset is
    ...
    own ``AdGroupAssetServiceClient.ad_group_asset_path()`` constructor
